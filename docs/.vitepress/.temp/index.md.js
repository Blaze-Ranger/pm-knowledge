...
const __pageData = JSON.parse('{"title":"PM Knowledge","description":"","frontmatter":{"layout":"home","title":"PM Knowledge","hero":{"name":"PM Knowledge","text":"学习 & 知识管理笔记","tagline":"个人知识库 — 计算机、产品、AI、阅读的零碎思考","actions":[{"theme":"brand","text":"开始阅读","link":"/notes/frontend/intro"},{"theme":"alt","text":"GitHub 仓库","link":"https://github.com/Blaze-Ranger/pm-knowledge"}]},"features":[{"icon":"🗂️","title":"结构化笔记","details":"按分类组织的 Markdown 笔记,支持标签、全文搜索、暗/亮主题切换。"},{"icon":"💬","title":"评论 & 订阅","details":"基于 GitHub Discussions 的 Giscus 评论,加 RSS 订阅,让知识持续流动。"},{"icon":"🚀","title":"自动化部署","details":"推送到 main 触发 GitHub Actions,自动构建并发布到 GitHub Pages。"}]},"headers":[],"relativePath":"index.md","filePath":"index.md","lastUpdated":null}');
