...
const __pageData = JSON.parse('{"title":"PRD 撰写清单","description":"撰写产品需求文档(PRD)时的自检清单。","frontmatter":{"title":"PRD 撰写清单","date":"2026-07-02T00:00:00.000Z","category":"product","tags":["prd","方法论","清单"],"description":"撰写产品需求文档(PRD)时的自检清单。"},"headers":[],"relativePath":"notes/product/intro.md","filePath":"notes/product/intro.md","lastUpdated":null}');
